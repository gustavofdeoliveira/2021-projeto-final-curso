          ...
          <div class="col-xl-10 col-xl-offset-1 col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
              ...
              <div class="col-xl-6 col-md-6 col-lg-6">
                ...
                <div class="row">
                  <div class="col-md-6 col-lg-4 col-xl-4" id="escolher-avatar" onclick="mudarAvatar(3)">
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4" id="escolher-avatar" onclick="mudarAvatar(6)">
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4" id="escolher-avatar" onclick="mudarAvatar(4)">
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4" id="escolher-avatar" onclick="mudarAvatar(5)">
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4" id="escolher-avatar" onclick="mudarAvatar(2)">
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4" id="escolher-avatar" onclick="mudarAvatar(1)">
