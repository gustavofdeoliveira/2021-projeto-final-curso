...
function setPublicacaoSemelhante()
{
    ...
    if (!empty($publicacao)) {
        ...
        for ($a = 0; $a != count($publicacao); $a++) {
            $semalhantes .= '<img class="img-publicacao-semelhante" id="img-publicacao-semelhante" src="' . $publicacao[$a]['imagem'] . '"><a class="titulo-publicacao-semelhante" target="_blank" href="//localhost/2021-projeto-final-curso/view/Ver-publicacao.php?id=' . $publicacao[$a]['id'] . '">' . $publicacao[$a]['titulo'] . '</a>';
        }
