...
function listarTermos()
{
    ...
    for ($a = 0; $a != count($termos); $a++) {
        ...
        $tabela_termos .= '<tr id="id-termos">' .
            ...
            '<input class="btn-excluir-atualizar"style="display:none" type="hidden" name="acao" value="verTermo"><button class="btn-excluir-atualizar" type="submit" name="idTermo" value="' . $termos[$a]['id'] . '"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></form>'.

            '<form action="../control/TermoControl.php" method="POST" class="form-group">' .
            '<input class="btn-excluir-atualizar"style="display:none" type="hidden" name="acao" value="excluirTermo"><button class="btn-excluir-atualizar" type="submit" name="Termo" value="' . $termos[$a]['id'] . '"><i class="fa fa-trash-o" aria-hidden="true"></i></button></form></td>' .
            '</tr>';
    }
