                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea required class="textarea form-control" rows="5" type="text" name="descricao"></textarea>
                                    <span class="error"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <textarea required class="textarea form-control" rows="10" type="text" name="outrostermos"></textarea>
                                    <span class="error"></span>
                                </div>
                            </div>
                        </div>
